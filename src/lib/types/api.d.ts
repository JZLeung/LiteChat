...
export interface ApiChatCompletionRequest {
	...
	/** vLLM: include usage stats in the final stream chunk */
...
export interface ApiChatCompletionStreamChunk {
	...
	choices: Array<{
		...
		delta: {
			content?: string;
			/** llama.cpp / OpenAI-compatible reasoning field */
			reasoning_content?: string;
			/** vLLM reasoning field (same as reasoning_content but named "reasoning") */
			reasoning?: string;
			model?: string;
	...
	/** vLLM: usage stats in the final chunk when stream_options.include_usage is true */
	usage?: {
