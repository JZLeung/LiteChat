...
>
	...
	<Button
		...
		variant="ghost"
		size="sm"
		onclick={() => (chatStore.enableThinking = !chatStore.enableThinking)}
		class="h-8 gap-1 px-2 text-xs hover:text-foreground {chatStore.enableThinking ? 'text-primary' : 'text-muted-foreground'}"
	>
